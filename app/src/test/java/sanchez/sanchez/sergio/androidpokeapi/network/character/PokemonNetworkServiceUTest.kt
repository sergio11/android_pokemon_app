...
class PokemonNetworkServiceUTest {
    ...
    fun test_network_001_get_two_characters_from_start(){
        runBlocking {
            ...
            val characters = pokemonService.getCharacterList(offset, limit)
    ...
    fun test_network_006_can_get_character_detail(){
        runBlocking {
            ...
            val characterDetail = pokemonService.getCharacterDetail(characterId)
